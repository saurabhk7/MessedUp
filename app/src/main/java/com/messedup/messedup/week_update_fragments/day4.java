    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(menu.size() > 0){
            if(menu.get(0).get("Meal").equals("Lunch")){
                ListView listView4lunch = (ListView)rootView.findViewById(R.id.listview4lunch);
                ...
                listView4lunch.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }if(menu.get(0).get("Meal").equals("Dinner")){
                ListView listView4dinner = (ListView)rootView.findViewById(R.id.listview4dinner);
                HashMap m = menu.get(0);
                ...
                list.removeAll(Collections.singleton("null"));
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.menu_list_view, list);
                listView4dinner.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
        }
        if(menu.size() > 1){
