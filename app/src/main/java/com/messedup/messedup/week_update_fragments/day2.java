    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(menu.size() > 0){
            if(menu.get(0).get("Meal").equals("Lunch")){
                ListView listView2lunch = (ListView)rootView.findViewById(R.id.listview2lunch);
                ...
                listView2lunch.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }if(menu.get(0).get("Meal").equals("Dinner")){
                ListView listView2dinner = (ListView)rootView.findViewById(R.id.listview2dinner);
                HashMap m = menu.get(0);
                ...
                list.removeAll(Collections.singleton("null"));
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.menu_list_view, list);
                listView2dinner.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
        }
        if(menu.size() > 1){
