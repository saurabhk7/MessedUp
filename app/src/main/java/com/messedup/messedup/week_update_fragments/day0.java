 ...
 * {@link day0.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link day0#newInstance} factory method to
...
public class day0 extends Fragment {
     ...
     * @return A new instance of fragment day0.
     */
    // TODO: Rename and change types and number of parameters
    public static day0 newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(menu.size() > 0){
            if(menu.get(0).get("Meal").equals("Lunch")){
                ListView listView0lunch = (ListView)rootView.findViewById(R.id.listview0lunch);
                ...
                listView0lunch.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }if(menu.get(0).get("Meal").equals("Dinner")){
                ListView listView0dinner = (ListView)rootView.findViewById(R.id.listview0dinner);
                HashMap m = menu.get(0);
