 ...
 * {@link day3.OnFragmentInteractionListener} interface
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(menu.size() > 0){
            if(menu.get(0).get("Meal").equals("Lunch")){
                ListView listView3lunch = (ListView)rootView.findViewById(R.id.listview3lunch);
                ...
                listView3lunch.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }if(menu.get(0).get("Meal").equals("Dinner")){
                ListView listView3dinner = (ListView)rootView.findViewById(R.id.listview3dinner);
                HashMap m = menu.get(0);
                ...
                list.removeAll(Collections.singleton("null"));
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.menu_list_view, list);
                listView3dinner.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
        }
        if(menu.size() > 1){
