 ...
 * {@link day5.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link day5#newInstance} factory method to
...
public class day5 extends Fragment {
     ...
     * @return A new instance of fragment day5.
     */
    // TODO: Rename and change types and number of parameters
    public static day5 newInstance(String param1, String param2) {
        day5 fragment = new day5();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_day5, container, false);
        if(menu.size() > 0){
            if(menu.get(0).get("Meal").equals("Lunch")){
                ListView listView5lunch = (ListView)rootView.findViewById(R.id.listview5lunch);
                ...
                listView5lunch.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }if(menu.get(0).get("Meal").equals("Dinner")){
                ListView listView5dinner = (ListView)rootView.findViewById(R.id.listview5dinner);
                HashMap m = menu.get(0);
                ...
                list.removeAll(Collections.singleton("null"));
                ArrayAdapter<String> adapter = new ArrayAdapter<String>(getActivity(), R.layout.menu_list_view, list);
                listView5dinner.setAdapter(adapter);
                adapter.notifyDataSetChanged();
            }
        }
        if(menu.size() > 1){
