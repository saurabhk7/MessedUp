...
public class TransactionHistoryCustomListAdapter extends ArrayAdapter<String> {
    ...
    public TransactionHistoryCustomListAdapter(Activity context, ArrayList<String> NotifDetails, ArrayList<String> NotifSmall
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.transaction_history_listview_item, null,true);
