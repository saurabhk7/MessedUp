...
public class CustomListAdapter extends ArrayAdapter<String> {
    ...
    public CustomListAdapter(Activity context, ArrayList<String> NotifDetails,ArrayList<String> NotifSmall
    ,ArrayList<String> TimeDetails) {
    ...
    public View getView(int position, View view, @NonNull ViewGroup parent) {
        ...
        View rowView=inflater.inflate(R.layout.notif_special_list_view_2, null,true);

        TextView txtTitle = (TextView) rowView.findViewById(R.id.notifDetailsTxt);
        ImageView imageView2 = (ImageView) rowView.findViewById(R.id.new_notif_icon_2);
        TextView extratxt = (TextView) rowView.findViewById(R.id.notif_small_details);
